...
where node >nul 2>&1 || (echo Node.js 22+ requis - https://nodejs.org & exit /b 1)
...
schtasks /create /f /tn "Zebralsace" /tr "\"%CD%\deploy\zebra-etiquettes.cmd\"" /sc onstart /ru SYSTEM /rl HIGHEST || exit /b 1
